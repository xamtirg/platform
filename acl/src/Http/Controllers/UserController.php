...
namespace Xamtirg\ACL\Http\Controllers;

use Assets;
use Xamtirg\Base\Events\UpdatedContentEvent;
use Xamtirg\Media\Services\ThumbnailService;
use Carbon\Carbon;
use Illuminate\Support\Facades\File;
use Illuminate\Support\Facades\Auth;
use Xamtirg\ACL\Forms\PasswordForm;
use Xamtirg\ACL\Forms\ProfileForm;
use Xamtirg\ACL\Forms\UserForm;
use Xamtirg\ACL\Tables\UserTable;
use Xamtirg\ACL\Http\Requests\CreateUserRequest;
use Xamtirg\ACL\Http\Requests\UpdatePasswordRequest;
use Xamtirg\ACL\Http\Requests\UpdateProfileRequest;
use Xamtirg\ACL\Models\UserMeta;
use Xamtirg\ACL\Repositories\Interfaces\RoleInterface;
use Xamtirg\ACL\Repositories\Interfaces\UserInterface;
use Xamtirg\ACL\Services\ChangePasswordService;
use Xamtirg\ACL\Services\CreateUserService;
use Xamtirg\Base\Events\CreatedContentEvent;
use Xamtirg\Base\Events\DeletedContentEvent;
use Xamtirg\Base\Forms\FormBuilder;
...
use Xamtirg\ACL\Http\Requests\AvatarRequest;
use Exception;
