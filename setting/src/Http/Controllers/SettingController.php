...
namespace Xamtirg\Setting\Http\Controllers;

use Assets;
use BaseHelper;
use Xamtirg\Base\Http\Controllers\BaseController;
use Xamtirg\Base\Http\Responses\BaseHttpResponse;
use Xamtirg\Base\Supports\Core;
use Xamtirg\Base\Supports\Language;
use Xamtirg\Media\Repositories\Interfaces\MediaFileInterface;
use Xamtirg\Setting\Http\Requests\EmailTemplateRequest;
use Xamtirg\Setting\Http\Requests\LicenseSettingRequest;
use Xamtirg\Setting\Http\Requests\MediaSettingRequest;
use Xamtirg\Setting\Http\Requests\ResetEmailTemplateRequest;
use Xamtirg\Setting\Http\Requests\SendTestEmailRequest;
use Xamtirg\Setting\Http\Requests\SettingRequest;
