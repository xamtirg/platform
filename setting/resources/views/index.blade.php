{{--
	...
	запускает : vendor\xamtirg\platform\setting\src\Http\Controllers\SettingController.php
--}}
@extends(BaseHelper::getAdminMasterLayoutTemplate())
@section('content')
    
	{{-- Блок выводит данные о лицензии --}}
                            ...
                            <div class="ui-select-wrapper">
                                <select name="locale" class="ui-select form-control select-search-full" id="locale">
                                    @php
                                        ...
                                        if (app()->environment('demo') && session('site-locale') && array_key_exists(session('site-locale'), \Xamtirg\Base\Supports\Language::getAvailableLocales())) {
                                            $defaultLocale = session('site-locale');
                                        }
                                    @endphp
                                    @foreach (\Xamtirg\Base\Supports\Language::getAvailableLocales() as $key => $locale)
