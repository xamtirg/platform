(($, DataTable) => {
    ...
    DataTable.ext.buttons.excel = {
        ...
        text: dt => {
            return '<i class="far fa-file-excel"></i> ' + dt.i18n('buttons.excel', XamtirgVariables.languages.tables.excel ? XamtirgVariables.languages.tables.excel : 'Excel');
        },
    ...
    DataTable.ext.buttons.export = {
        ...
        text: dt => {
            return '<i class="fa fa-download"></i> ' + dt.i18n('buttons.export', XamtirgVariables.languages.tables.export ? XamtirgVariables.languages.tables.export : 'Export') + '&nbsp;<span class="caret"/>';
        },
    ...
    DataTable.ext.buttons.csv = {
        ...
        text: dt => {
            return '<i class="fas fa-file-csv"></i> ' + dt.i18n('buttons.csv', XamtirgVariables.languages.tables.csv ? XamtirgVariables.languages.tables.csv : 'CSV');
        },
    ...
    DataTable.ext.buttons.print = {
        ...
        text: dt => {
            return '<i class="fa fa-print"></i> ' + dt.i18n('buttons.print', XamtirgVariables.languages.tables.print ? XamtirgVariables.languages.tables.print : 'Print');
        },
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: dt => {
            return '<i class="fa fa-undo"></i> ' + dt.i18n('buttons.reset', XamtirgVariables.languages.tables.reset ? XamtirgVariables.languages.tables.reset : 'Reset');
        },
    ...
    DataTable.ext.buttons.reload = {
        ...
        text: dt => {
            return '<i class="fas fa-sync"></i> ' + dt.i18n('buttons.reload', XamtirgVariables.languages.tables.reload ? XamtirgVariables.languages.tables.reload : 'Reload');
        },
    ...
    class TableManagement {
        ...
        handleActionsRow() {
            ...
            $(document).on('click', '.delete-many-entry-trigger', event => {
                ...
                if (ids.length === 0) {
                    Xamtirg.showError(XamtirgVariables.languages.tables.please_select_record ? XamtirgVariables.languages.tables.please_select_record : 'Please select at least one record to perform this action!');
                    return false;
                }
        ...
        loadBulkChangeData($element) {
            ...
            $.ajax({
                ...
                success: res => {
                    ...
                    Xamtirg.initResources();
                },
                error: error => {
                    Xamtirg.handleError(error);
                }
            });
        }
