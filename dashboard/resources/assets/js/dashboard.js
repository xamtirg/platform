            ...
            success: res => {
                ...
                if (!res.error) {
                    ...
                    if (el.find('.scroller').length !== 0) {
                        Xamtirg.callScroll(el.find('.scroller'));
                    }
            ...
            Sortable.create(el, {
                ...
                onUpdate: () => {
                    ...
                    $.ajax({
                        ...
                        success: res => {
                            if (!res.error) {
                                Xamtirg.showSuccess(res.message);
                            } else {
                                Xamtirg.showError(res.message);
                            }
                        },
                        error: data => {
    ...
    init() {
        ...
        list_widgets.on('change', '.number_record .numb', e => {
            ...
            if (!isNaN(paginate) && paginate > 0) {
                ...
                Xamtirg.showError('Please input a number!')
            }
        });
