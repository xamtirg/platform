...
use BaseHelper;
use Xamtirg\Base\Exceptions\Handler;
use Xamtirg\Base\Hooks\EmailSettingHooks;
use Xamtirg\Base\Http\Middleware\CoreMiddleware;
use Xamtirg\Base\Http\Middleware\DisableInDemoModeMiddleware;
use Xamtirg\Base\Http\Middleware\HttpsProtocolMiddleware;
use Xamtirg\Base\Http\Middleware\LocaleMiddleware;
use Xamtirg\Base\Models\AdminNotification;
use Xamtirg\Base\Models\MetaBox as MetaBoxModel;
use Xamtirg\Base\Repositories\Caches\MetaBoxCacheDecorator;
use Xamtirg\Base\Repositories\Eloquent\MetaBoxRepository;
use Xamtirg\Base\Repositories\Interfaces\MetaBoxInterface;
use Xamtirg\Base\Supports\Action;
use Xamtirg\Base\Supports\BreadcrumbsManager;
use Xamtirg\Base\Supports\CustomResourceRegistrar;
use Xamtirg\Base\Supports\Filter;
use Xamtirg\Base\Supports\GoogleFonts;
use Xamtirg\Base\Supports\Helper;
use Xamtirg\Base\Traits\LoadAndPublishDataTrait;
use Xamtirg\Base\Widgets\AdminWidget;
use Xamtirg\Base\Widgets\Contracts\AdminWidget as AdminWidgetContract;
use Xamtirg\Setting\Providers\SettingServiceProvider;
use Xamtirg\Setting\Supports\SettingStore;
use Xamtirg\Support\Http\Middleware\BaseMiddleware;
use DateTimeZone;
...
class BaseServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app['config']->set([
            'session.cookie' => 'xamtirg_session',
